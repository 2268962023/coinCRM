package com.three.coinexchange.interceptor;


import com.three.coinexchange.bean.SysUser;
import com.three.coinexchange.exceptions.NoLoginException;
...
// 判断用户ID是否不为空，且数据库中存在对应的用户记录
        if (null == userId || null == sysUserService.selectByPrimaryKey(userId)) {
// 抛出未登录异常
