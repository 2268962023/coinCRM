    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layui-hide-xs"><a class="layui-icon layui-icon-website"
                                                        href="http://www.pearadmin.com"></a></li>
            ...
            <li class="layui-nav-item user">
                ...
                <dl class="layui-nav-child">
                    <dd><a user-menu-id="5555" user-menu-title="基本资料" user-menu-url="/user/center">基本资料</a></dd>
...
<script>
    layui.use(['admin', 'jquery', 'layer', 'popup'], function () {
        ...
        admin.setConfigPath("/admin/pear.config.yml");
        admin.render();
